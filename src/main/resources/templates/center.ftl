    ...
    <div id="wrapper" class="toggled">
        ...
        <div id="page-content-wrapper" style="padding-top: 10px">
            <div class="col-md-12 column">
                ...
                <div class="carousel slide" id="carousel-503229">
                    <ol class="carousel-indicators">
                        <li class="active" data-slide-to="0" data-target="#carousel-503229">
                        </li>
                        <li data-slide-to="1" data-target="#carousel-503229">
                        </li>
                        <li data-slide-to="2" data-target="#carousel-503229">
                        </li>
                    </ol>
