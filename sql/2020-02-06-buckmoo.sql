...
-- ----------------------------
INSERT INTO `position_info` VALUES ('1580022960792934855', '周末影院兼职', '600元/天', 0, '13JDE9W0D8EW9D90DWE', 1, '1#3#', '周末影院兼职,负责检验票据等简单的工作', '临潼太平洋影城3层7号厅', 12, '15291418231', 0, 'oxrwq0zPbgTB-gV9Y4Q-hN4g25Fk', 1580022960791, 1580728960792, 1, '信息很完整，AAA');
...
-- ----------------------------
INSERT INTO `student_info` VALUES ('oxrwq0xrKKyqiAGE8O9TM3L1yaQY', '1', '1', 'http://lslm.live:8090/fileserver/file/fileDownload?fileUrl=4f1fc0d9-8f20-44f0-b046-dcc21cd17c19.png', '1', NULL, 0, 1580904230186);
